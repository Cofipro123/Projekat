...
int main()
{
    ...
    {
        h++;
        cout<< "Ako ste posetilac, pritisnite 1,"<<endl<< "Ako ste zaposleni, pritisnite 2,"<<endl<< "Ažko ste organizator pritisnite 3."<<endl<< "Pritisnite 0 da izadjete iz aplikacije"<<endl;
        cin>>l;
        if(l == 1)
